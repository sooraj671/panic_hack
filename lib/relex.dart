...
class Relex extends StatefulWidget {
  const Relex({Key? key}) : super(key: key);
  @override
  State<Relex> createState() => _RelexState();
}

class _RelexState extends State<Relex> with WidgetsBindingObserver {
  ...
  Future setAudio() async {
    ...
    final url = await player.load('calm.mp3');
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  child: RichText(
                    text: TextSpan(
                      text: 'Listen to this as soon as possible',
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 30,
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text: ' after having a panic attack',
                            style: TextStyle(
              ...
              Padding(
                ...
                child: Container(
                    child: Text(
                  'Then once a day for 7 days. Then as often as you like to free your mind.',
                  style: TextStyle(
                      fontSize: 16,
