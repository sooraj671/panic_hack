...
class _RecoverState extends State<Recover> with WidgetsBindingObserver {
  ...
  Future setAudio() async {
    ...
    final url = await player.load('fix.mp3');
        ...
        child: Column(
            ...
            children: [
                ...
                child: Container(
                  child: RichText(
                    text: TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text: ' and feel safe and in control again',
                            style: TextStyle(
              ...
              Padding(
                ...
                child: Container(
                    child: Text(
                  'Listen to this twice in the first seven days of using this app',
                  style: TextStyle(
                      fontSize: 16,
