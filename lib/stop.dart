...
class _StopState extends State<Stop> with WidgetsBindingObserver {
  ...
  Future setAudio() async {
    ...
    final url = await player.load('hack.mp3');
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        child: RichText(
                          text: TextSpan(
                            text:
                                'Use this if you are having a panic attack now',
                            style: TextStyle(
                              color: Colors.black,
                              fontSize: 30,
                    ...
                    Padding(
                      ...
                      child: Container(
                          child: Text(
                        'Otherwise listen to the other three tracks in order within the next 24 hours.',
                        style: TextStyle(
                            fontSize: 16,
                            ...
                            children: [
                              ...
                              Container(
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    // IconButton(
                                    //
                                    //   icon: Icon(Icons.forward_10,size: 40,color: Color(0xff888888)),
                                    //   onPressed: () {
                                    //     skipForward();
                                    //     // Add your logic to skip forward 15 seconds here
                                    //   },
                                    // ),
                                  ],
                                ),
                              ...
                              SliderTheme(
                                data: SliderThemeData(
                                  ...
                                  thumbColor: Color(
                                      0xff989898), // change the thumb color
                                  overlayColor: Color(0xff47557E).withOpacity(
                                      0.1), // change the overlay color
